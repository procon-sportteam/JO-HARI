...
public class Pos_txt_Reader : MonoBehaviour
{
    ...
    //public String pos_filename = Application.persistentDataPath + "/Pos.txt";
    ...
    {
        /*
        var file = Application.persistentDataPath + "/Pos.txt";
        ...
        {
            throw new ApplicationException("読み込めていません");
        }
        */
        string strCurDir = System.Environment.CurrentDirectory;
        Debug.Log(strCurDir);
        Debug.Log("aaaaaaaaaaaaaaaaaaaaaaa" + strCurDir);
